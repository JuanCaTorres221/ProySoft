    ...
    public void seedEmotions() {
        if (emotionRepository.count() == 0) {
            List<Emotion> emotions = List.of(
                    ...
                    new Emotion(null, "Relajado", "Verde", 4, "Sensación de calma y tranquilidad"),
                    new Emotion(null, "Motivado", "Dorado", 5, "Deseo de lograr algo con entusiasmo"),
                    new Emotion(null, "Cansado", "Gris", 2, "Sensación de agotamiento físico o mental"),
                    new Emotion(null, "Sorprendido", "Violeta", 4, "Reacción ante algo inesperado")
            );
